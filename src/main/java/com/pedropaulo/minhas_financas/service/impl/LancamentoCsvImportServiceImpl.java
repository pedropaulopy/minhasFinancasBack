...
public class LancamentoCsvImportServiceImpl implements LancamentoCsvImportService {
	...
	public LancamentoCsvImportServiceImpl(LancamentoService lancamentoService, CategoriaRepository categoriaRepository,
			UsuarioRepository usuarioRepository, TransactionTemplate transactionTemplate) {
	...
	private LinhaParseada mapearLinha(CSVRecord rec, Long usuarioAutenticadoId, long linhaAbsoluta)
	...
	private static String lRaw(Lancamento l) {
		return l == null ? "" : String.valueOf(l.getDescricao());
	}
